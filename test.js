...
const run = async () => {
	console.log("Test run @molfar/service-fasttext")
	...
	container.hold(servicePath, "@molfar/service-fasttext")
	const service = await container.startInstance(container.getService(s => s.name == "@molfar/service-fasttext"))
